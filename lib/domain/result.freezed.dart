...
mixin _$Result<T> {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(Exception error, StackTrace stack) failure,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
  TResult? whenOrNull<TResult extends Object?>({
    TResult? Function(T data)? success,
    TResult? Function(Exception error, StackTrace stack)? failure,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
...
abstract class _$$FailureCopyWith<T, $Res> {
  ...
  @useResult
  $Res call({Exception error, StackTrace stack});
}
...
class _$Failure<T> extends Failure<T> {
  const _$Failure({required this.error, required this.stack}) : super._();
  ...
  @override
  int get hashCode => Object.hash(runtimeType, error, stack);
...
abstract class Failure<T> extends Result<T> {
  const factory Failure(
      ...
      required final StackTrace stack}) = _$Failure<T>;
